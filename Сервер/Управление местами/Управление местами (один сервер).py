...
class SeatManager(reservation_pb2_grpc.ReservationServiceServicer):
    def __init__(self, db_connection):
        # инициализация SeatManager с подключением к базе данных
    ...
    def ReserveSeat(self, request, context):
        ...
        try:
            # проверка текущего состояния комнаты в базе данных и выполнение бронирования
...
def serve_reservation():
    config = read_config("confseatmanserv.txt")
